...
//  StoreSearch
//
//  Created by Mikhail Ustyantsev on 08.09.2022.
//

import Foundation
//Here, you declare a type for your own closure, named SearchComplete. This is a closure that returns no value (it is Void) and takes one parameter, a Bool
